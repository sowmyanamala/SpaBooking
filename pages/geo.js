...
const GeolocationExample = () => {
  ...
  const getAddressFromCoordinates = async (lat, lon) => {
    try {
      ...
      if (data && data.address) {
        ...
        const fullAddress = `${locationName ? locationName + ", " : ""}${
          state || ""
        }, ${country || ""}`;
  ...
  const filteredTherapists = nearbyTherapists.filter((therapist) => {
    return (
      (!filters.name ||
        therapist.name.toLowerCase().includes(filters.name.toLowerCase())) &&
          ...
          <div className={styles.therapistList}>
            {searchingTherapists ? (
              ...
              filteredTherapists.map((therapist) => (
                <div
                  key={therapist.id}
                  className={`${styles.therapistItem} ${
                    selectedTherapist?.id === therapist.id ? styles.active : ""
                  }`}
                    ...
                    <div className={styles.therapistInfo}>
                      ...
                      <p className={styles.therapistSpecialty}>
                        {therapist.service_area ||
                          therapist.service_area_primary ||
                          "Massage Therapy"}
                      </p>
              ...
              >
                ...
                <p style={{ fontSize: "14px", marginTop: "8px" }}>
                  Try increasing your search radius or getting your location
                  first
                </p>
              </div>
            )}
          ...
          <div className={styles.filterSection}>
            ...
            <div className={styles.filterGroup}>
              ...
              <select
                ...
                onChange={(e) =>
                  handleFilterChange("deliveredType", e.target.value)
                }
              >
